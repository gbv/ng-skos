...
angular.module('ngSKOS').run([
  ...
  function ($templateCache) {
    ...
    $templateCache.put('template/skos-tree.html', '<div style="" class="skos-tree"><p class="set" ng-if="!tree.topConcepts"><span ng-if="tree.notation" class="notation">{{tree.notation[0]}}</span> <span class="nlabel" style="display:table-cell">{{tree.prefLabel.de}}</span></p><ul><li ng-repeat="n in tree.narrower ? tree.narrower : tree.topConcepts"><span skos-tree="n"></span></li></ul></div>');
  }
]);